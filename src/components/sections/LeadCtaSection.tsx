      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="rounded-[20px] bg-gradient-to-r from-gf-primary to-gf-secondary text-white p-8 sm:p-12 lg:p-14 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-4 items-start lg:items-end justify-center">
              <a href="#pricing" className="gf-btn-white w-full sm:w-auto text-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center pt-6">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold text-gf-primary">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-gf-primary">Full Name *</label>
                      <input
                        type="text"
                        required
                        ...
                        className="w-full px-4 py-2.5 rounded-xl border border-gf-border bg-white text-sm focus:outline-none focus:border-gf-secondary"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-gf-primary">Work Email *</label>
                      <input
                        type="email"
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-gf-primary">Organization / Estate</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-bold text-gf-primary">Participation Intent</label>
                      <select
                  ...
                  <button type="submit" className="gf-btn-primary w-full justify-center py-3">
